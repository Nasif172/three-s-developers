export default function ProjectsPage() {
  return (
    <main className="min-h-screen bg-gray-50 py-20 px-4">
      ...
      {/* Project 1: Abakash Lake View */}
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 mb-8">
        <div className="p-8">
          <div className="flex flex-col md:flex-row justify-between items-start mb-6">
            <h2 className="text-3xl font-bold text-slate-900">Abakash Lake View Society</h2>
            <span className="mt-2 md:mt-0 bg-green-100 text-green-800 font-bold px-4 py-2 rounded-full">
              Available
            </span>
          </div>
